...
def is_long_word(word, length=5):
    ...
    True
    """
    return len(word) >= length  # Change this line from '>' to '>='
...
def format_sentence(phrase):
    ...
    'It is an ex parrot.'
    >>> format_sentence('this is a valid test')
    'This is a valid test.'
    """
    # Capitalize the first character and add a period if needed.
    formatted_phrase = phrase.strip()
    if not formatted_phrase:
        return ''

    if formatted_phrase[0].isalpha():
